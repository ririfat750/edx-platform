...
class TestMixedModuleStore(CommonMixedModuleStoreSetup):
    ...
    def test_reset_to_version(self):
        """
        Test calling `DraftVersioningModuleStore.reset_to_version`.
        """
        # Set up test course.
        ...
        self.store.reset_to_version(self.course.location.course_key, original_version_guid)
