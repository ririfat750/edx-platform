...
class TestCommand(TestCase):
    ...
    The underlying implementation (`DraftVersioningModulestore.reset_to_version`)
    ...
    @mock.patch.object(MixedModuleStore, "reset_to_version")
    def test_good_arguments(self, mock_reset_to_version):
        call_command("reset_course_content", "course-v1:a+b+c", "0123456789abcdef01234567")
        mock_reset_to_version.assert_called_once_with(
